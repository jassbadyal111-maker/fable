(() => {
  ...
  if(conversation){
    let follow=true,programmatic=false,lastUserScroll=0;
    const threshold=120;
    ...
    window.scrollBottom=jump;window.fableForceScroll=force;
    $('composer')?.addEventListener('submit',force,true);$('newChatBtn')?.addEventListener('click',()=>follow=true,true);
  ...
  const settingsIcon=$('settingsBtn');if(settingsIcon){const old=settingsIcon.querySelector('span');if(old)old.outerHTML='<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 8.4a3.6 3.6 0 1 0 0 7.2 3.6 3.6 0 0 0 0-7.2Zm8.2 3.6c0-.6-.1-1.2-.2-1.8l1.7-1.3-1.9-3.2-2 .8a8.5 8.5 0 0 0-3.1-1.8L14.4 2h-3.8l-.3 2.7a8.5 8.5 0 0 0-3.1 1.8l-2-.8-1.9 3.2L5 10.2A8 8 0 0 0 4.8 12c0 .6.1 1.2.2 1.8l-1.7 1.3 1.9 3.2 2-.8a8.5 8.5 0 0 0 3.1 1.8l.3 2.7h3.8l.3-2.7a8.5 8.5 0 0 0 3.1-1.8l2 .8 1.9 3.2-1.7 1.3c.1-.6.2-1.2.2-1.8Z"/></svg>';settingsIcon.classList.add('vector-icon')}
